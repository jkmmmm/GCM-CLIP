...
CUDA_VISIBLE_DEVICES=0 python3 -m open_clip_train.main \
    ...
    --pretrained /root/autodl-fs/clip_log/2025_10_20-20_01_50-model_hf-hub:microsoft-BiomedCLIP-PubMedBERT_256-vit_base_patch16_224-lr_0.0001-b_64-j_4-p_amp/checkpoints/epoch_20.pt \
    --save-best \
