...
def parse_args(args):
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to config file for additional parameters",
    )
    parser.add_argument(
        "--train-num-samples",
        type=int,
    ...
    parser.add_argument(
        "--csv-disease-category",
        type=str,
        default=None,
        help="For csv-like datasets, the name of the key for the disease category."
    )
    parser.add_argument(
        "--csv-disease-location",
        type=str,
        default=None,
        help="For csv-like datasets, the name of the key for the disease locations."
    )
    parser.add_argument(
        "--imagenet-val",
        type=str,
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="Always save the best model",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        default=False,
        action='store_true',
        help="Force use of category mining model (separate text-tower).",
    )
    parser.add_argument(
        "--cls_model",
        default=False,
        action='store_true',
        help="Force use of cls model and cls loss.",
    )
    parser.add_argument(
        "--torchscript",
        default=False,
    ...
    parser.add_argument(
        "--teacher-update-freq", type=int, default=1, help="Update the teacher model every --acum-freq steps."
    )
    parser.add_argument(
