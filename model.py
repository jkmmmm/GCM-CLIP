...
class cls_CMCLIP(nn.Module):
    ...
    def __init__(
        ...
        # 分类头，线性映射
        cls_num = 10
        self.cls_head = nn.linear(embed_dim, cls_num)
    ...
    def forward(
        ...
        cls_logits = self.cls_head(image_features)
        ...
        if self.logit_bias is not None:
            return image_features, text_features, cls_feature, self.logit_bias
        return image_features, text_features, cls_feature
